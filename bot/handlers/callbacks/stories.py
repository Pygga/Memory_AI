...
async def handle_select_story(callback: CallbackQuery) -> None:
    ...
    await callback.message.edit_text(
        ...
        f"• <b>Главы:</b> {chapters_status}\n\n"
        "Здесь вы управляете структурой книги и её экспортом:\n"
        "1. <b>Редактирование глав</b>: Нажмите кнопку ниже, чтобы просмотреть ИИ-структуру, изменить текст или перегенерировать главы.\n"
        "2. <b>Экспорт в PDF</b>: Выберите дизайн и скачайте книгу после того, как все главы будут готовы.",
