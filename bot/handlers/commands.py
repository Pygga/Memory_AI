...
async def cmd_start(message: Message) -> None:
    ...
    await message.answer(
        "👋 <b>Добро пожаловать в Memory Book!</b>\n\n"
        "Я помогу вам бережно сохранить воспоминания и оформить их в профессионально сверстанную книгу с помощью ИИ.\n\n"
        "📥 <b>Как это работает:</b>\n"
        "1. Создайте новую книгу кнопкой ниже (например, <i>«Дневник 2026»</i>).\n"
        "2. Отправляйте в чат любые текстовые, голосовые сообщения или фотографии.\n"
        "3. Перейдите в раздел <b>«📚 Мои книги»</b>, чтобы настроить структуру ИИ-глав и скачать готовый PDF.\n\n"
        "<i>Начнем? Нажмите кнопку ниже.</i>",
        reply_markup=ReplyKeyboardRemove()
    )
    
    if active_story:
        active_book_info = (
            f"• <b>Текущая книга:</b> «{active_story.title}»\n"
            f"• <b>Накоплено воспоминаний:</b> {memories_count}"
        )
    else:
        active_book_info = (
            "• <b>Текущая книга:</b> <i>Не выбрана</i>\n"
            "💡 Нажмите <b>«🆕 Начать новую книгу»</b> ниже, чтобы начать."
        )
